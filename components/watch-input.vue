<template>
	...
	<view  class="rapper">
		...
		<input :disabled="disable" class="myinput" @focus="focus" @blur="blur" :value="value" :type="_type" :maxlength="maxlength" :placeholder="place_1" :password="type === 'password'" @input="onInput" >
